...
public class ProfissionalBase {
    private static final List<String> PROFISSIONAIS = Arrays.asList(
    ...
    public static boolean ProfissionalValido(String nomeProfissional) {
        return PROFISSIONAIS.stream().anyMatch(Profissional -> Profissional.equalsIgnoreCase(nomeProfissional));
    }
}
